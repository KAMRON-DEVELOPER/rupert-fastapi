...
class VacancyModel(BaseLocationModel):
    ...
    work_format: Mapped[WorkFormat] = mapped_column(
        Enum(WorkFormat, name="work_format"), default=WorkFormat.onsite, nullable=False
    )
    ...
    status: Mapped[VacancyStatus] = mapped_column(
        Enum(VacancyStatus, name="vacancy_status"), default=VacancyStatus.draft, nullable=False
    )
    # Relationships
    ...
    skills: Mapped[list[SkillModel]] = relationship(
        secondary="vacancy_skill_links", back_populates="vacancies", viewonly=True
    )
...
class ApplicationModel(BaseModel):
    ...
    __table_args__ = (UniqueConstraint("applicant_id", "vacancy_id", name="uq_application"),)
...
class SavedVacancyModel(BaseModel):
    ...
    __table_args__ = (UniqueConstraint("user_id", "vacancy_id", name="uq_saved_vacancy"),)
