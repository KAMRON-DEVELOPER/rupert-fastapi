...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("pending", "approved", "rejected", "suspended", name="company_status"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "suspended", "pending_verification", "deleted", name="user_status"),
            nullable=False,
        ),
        sa.Column("follow_policy", sa.Enum("auto_accept", "require_approval", name="follow_policy"), nullable=False),
        sa.Column(
            "job_search_status",
            sa.Enum("actively_looking", "open_to_offers", "interviewing", "not_looking", name="job_search_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "salary_currency",
            sa.Enum("UZS", "KZT", "KGS", "TJS", "TMT", "USD", "EUR", "TRY", name="salary_currency"),
            nullable=True,
        ),
        ...
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), nullable=False),
        sa.CheckConstraint(
            "salary_expectation_min <= salary_expectation_max", name="chk_resume_salary_expectation_range"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "viewed", "shortlisted", "interview", "offer", "rejected", "hired", name="application_status"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("quote", "repost", "like", "view", "bookmark", name="feed_engagement_type"), nullable=False
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), nullable=False),
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), nullable=False),
